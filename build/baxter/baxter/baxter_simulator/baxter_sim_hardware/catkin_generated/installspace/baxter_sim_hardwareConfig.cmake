...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT baxter_sim_hardware_NUM_DUMMY_TARGETS)
      set(baxter_sim_hardware_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::baxter_sim_hardware::wrapped-linker-option${baxter_sim_hardware_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR baxter_sim_hardware_NUM_DUMMY_TARGETS "${baxter_sim_hardware_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::baxter_sim_hardware::wrapped-linker-option${baxter_sim_hardware_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND baxter_sim_hardware_LIBRARIES "${interface_target_name}")
