...
if("TRUE" STREQUAL "TRUE")
  set(rethink_ee_description_SOURCE_PREFIX /home/vagrant/ros_ws/src/baxter/baxter/baxter_common/rethink_ee_description)
  set(rethink_ee_description_DEVEL_PREFIX /home/vagrant/ros_ws/devel)
  ...
  set(rethink_ee_description_INSTALL_PREFIX /home/vagrant/ros_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'rethink_ee_description' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'rethink_ee_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/vagrant/ros_ws/src/baxter/baxter/baxter_common/rethink_ee_description/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT rethink_ee_description_NUM_DUMMY_TARGETS)
      set(rethink_ee_description_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::rethink_ee_description::wrapped-linker-option${rethink_ee_description_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR rethink_ee_description_NUM_DUMMY_TARGETS "${rethink_ee_description_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::rethink_ee_description::wrapped-linker-option${rethink_ee_description_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND rethink_ee_description_LIBRARIES "${interface_target_name}")
