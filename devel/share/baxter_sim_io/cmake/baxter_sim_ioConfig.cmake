...
if("TRUE" STREQUAL "TRUE")
  set(baxter_sim_io_SOURCE_PREFIX /home/vagrant/ros_ws/src/baxter/baxter/baxter_simulator/baxter_sim_io)
  set(baxter_sim_io_DEVEL_PREFIX /home/vagrant/ros_ws/devel)
  ...
  set(baxter_sim_io_INSTALL_PREFIX /home/vagrant/ros_ws/install)
...
if(NOT "/home/vagrant/ros_ws/src/baxter/baxter/baxter_simulator/baxter_sim_io/include " STREQUAL " ")
  set(baxter_sim_io_INCLUDE_DIRS "")
  set(_include_dirs "/home/vagrant/ros_ws/src/baxter/baxter/baxter_simulator/baxter_sim_io/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'baxter_sim_io' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/vagrant/ros_ws/src/baxter/baxter/baxter_simulator/baxter_sim_io/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT baxter_sim_io_NUM_DUMMY_TARGETS)
      set(baxter_sim_io_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::baxter_sim_io::wrapped-linker-option${baxter_sim_io_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR baxter_sim_io_NUM_DUMMY_TARGETS "${baxter_sim_io_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::baxter_sim_io::wrapped-linker-option${baxter_sim_io_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND baxter_sim_io_LIBRARIES "${interface_target_name}")
