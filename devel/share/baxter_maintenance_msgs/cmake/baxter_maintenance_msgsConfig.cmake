...
if("TRUE" STREQUAL "TRUE")
  set(baxter_maintenance_msgs_SOURCE_PREFIX /home/vagrant/ros_ws/src/baxter/baxter/baxter_common/baxter_maintenance_msgs)
  set(baxter_maintenance_msgs_DEVEL_PREFIX /home/vagrant/ros_ws/devel)
  ...
  set(baxter_maintenance_msgs_INSTALL_PREFIX /home/vagrant/ros_ws/install)
...
if(NOT "/home/vagrant/ros_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'baxter_maintenance_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/vagrant/ros_ws/src/baxter/baxter/baxter_common/baxter_maintenance_msgs/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT baxter_maintenance_msgs_NUM_DUMMY_TARGETS)
      set(baxter_maintenance_msgs_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::baxter_maintenance_msgs::wrapped-linker-option${baxter_maintenance_msgs_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR baxter_maintenance_msgs_NUM_DUMMY_TARGETS "${baxter_maintenance_msgs_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::baxter_maintenance_msgs::wrapped-linker-option${baxter_maintenance_msgs_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND baxter_maintenance_msgs_LIBRARIES "${interface_target_name}")
