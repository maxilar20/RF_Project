...
if("TRUE" STREQUAL "TRUE")
  set(baxter_core_msgs_SOURCE_PREFIX /home/vagrant/ros_ws/src/baxter/baxter/baxter_common/baxter_core_msgs)
  set(baxter_core_msgs_DEVEL_PREFIX /home/vagrant/ros_ws/devel)
  ...
  set(baxter_core_msgs_INSTALL_PREFIX /home/vagrant/ros_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'baxter_core_msgs' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'baxter_core_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/vagrant/ros_ws/src/baxter/baxter/baxter_common/baxter_core_msgs/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT baxter_core_msgs_NUM_DUMMY_TARGETS)
      set(baxter_core_msgs_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::baxter_core_msgs::wrapped-linker-option${baxter_core_msgs_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR baxter_core_msgs_NUM_DUMMY_TARGETS "${baxter_core_msgs_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::baxter_core_msgs::wrapped-linker-option${baxter_core_msgs_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND baxter_core_msgs_LIBRARIES "${interface_target_name}")
